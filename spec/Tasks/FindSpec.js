...
describe("L.esri.Find", () => {
  ...
  it("should find features with provided layer id and search text", (done) => {
    server.respondWith(
      "GET",
      `${mapServiceUrl}find?sr=4326&contains=true&returnGeometry=true&returnZ=true&returnM=false&layers=0&searchText=Site&f=json`,
  ...
  it("should find features by specified search field", (done) => {
    server.respondWith(
      "GET",
      `${mapServiceUrl}find?sr=4326&contains=true&returnGeometry=true&returnZ=true&returnM=false&layers=0&searchText=Site&searchFields=Field&f=json`,
  ...
  it("should find an exact match for the search text", (done) => {
    server.respondWith(
      "GET",
      `${mapServiceUrl}find?sr=4326&contains=false&returnGeometry=true&returnZ=true&returnM=false&layers=0&searchText=Site&f=json`,
      JSON.stringify(sampleResponse),
    );
  ...
  it("should fetch unformatted results from 10.5+", (done) => {
    server.respondWith(
      "GET",
      `${mapServiceUrl}find?sr=4326&contains=true&returnGeometry=true&returnZ=true&returnM=false&layers=0&searchText=Site&returnUnformattedValues=true&f=json`,
      JSON.stringify(sampleResponse),
    );
  ...
  it("should find features and limit geometries to a given precision", (done) => {
    server.respondWith(
      "GET",
      `${mapServiceUrl}find?sr=4326&contains=true&returnGeometry=true&returnZ=true&returnM=false&layers=0&searchText=Site&geometryPrecision=4&f=json`,
      JSON.stringify(sampleResponse),
    );
  ...
  it("should find features without geometry", (done) => {
    server.respondWith(
      "GET",
      `${mapServiceUrl}find?sr=4326&contains=true&returnGeometry=false&returnZ=true&returnM=false&layers=0&searchText=Site&f=json`,
    ...
    task
      ...
      .run((error, featureCollection, raw) => {
        expect(featureCollection).to.deep.equal(
          sampleFeatureCollectionWithoutGeometry,
        );
  ...
  it("should identify features with a token", (done) => {
    server.respondWith(
      "GET",
      `${mapServiceUrl}find?sr=4326&contains=true&returnGeometry=true&returnZ=true&returnM=false&layers=0&searchText=Site&token=foo&f=json`,
      JSON.stringify(sampleResponse),
    );
  ...
  it("should pass through arbitrary request parameters", (done) => {
    ...
    server.respondWith(
      "GET",
      `${mapServiceUrl}find?sr=4326&contains=true&returnGeometry=true&returnZ=true&returnM=false&layers=0&searchText=Site&foo=bar&f=json`,
      JSON.stringify(sampleResponse),
    );
