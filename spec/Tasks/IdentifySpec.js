describe('L.esri.Tasks.Identify', function () {
  ...
  // create map
  var map = L.map(createMapDiv()).setView([45.51, -122.66], 16);
  ...
  it('should identify features', function(){
  ...
  it('should identify features in a given time range', function(){
  ...
  it('should restrict identification to specific layers', function(){
    server.respondWith('GET', url + 'identify?sr=4326&layers=all&tolerance=3&imageDisplay=500%2C500%2C96&mapExtent=-122.66535758972167%2C45.50624163368495%2C-122.65462875366211%2C45.51376023843158&geometry=-122.66%2C45.51&geometryType=esriGeometryPoint&layers=top&f=json', JSON.stringify(sampleResponse));
  ...
  it('should identify features and limit geometries to a given precision', function(){
  ...
  it('should identify features and simplify geometries', function(){
  ...
  it('should identify features with a token', function(){
  ...
  it('should identify features within a certain pixel tolerance', function(){
    server.respondWith('GET', url + 'identify?sr=4326&layers=all&tolerance=3&imageDisplay=500%2C500%2C96&mapExtent=-122.66535758972167%2C45.50624163368495%2C-122.65462875366211%2C45.51376023843158&geometry=-122.66%2C45.51&geometryType=esriGeometryPoint&tolerance=4&f=json', JSON.stringify(sampleResponse));
  ...
  it('should use a service to execute the request', function(){
