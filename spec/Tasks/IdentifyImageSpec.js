...
describe("L.esri.IdentifyImage", () => {
  ...
  const sampleResponseWithCatalogItems = {
    ...
    properties: {
      Values: ["10 18 34 43", "17 22 39 45"],
    },
    catalogItems: {
    ...
    catalogItemVisibilities: [0.671180049953907, 0.328819950035319],
  };
  ...
  it("should identify a pixel value at location", (done) => {
    server.respondWith(
      "GET",
      `${imageServiceUrl}identify?returnGeometry=false&geometry=%7B%22x%22%3A-122.66%2C%22y%22%3A45.51%2C%22spatialReference%22%3A%7B%22wkid%22%3A4326%7D%7D&geometryType=esriGeometryPoint&f=json`,
  ...
  it("should identify a pixel value with mosaic rule", (done) => {
    ...
    server.respondWith(
      "GET",
      `${imageServiceUrl}identify?returnGeometry=false&geometry=%7B%22x%22%3A-122.66%2C%22y%22%3A45.51%2C%22spatialReference%22%3A%7B%22wkid%22%3A4326%7D%7D&geometryType=esriGeometryPoint&mosaicRule=%7B%22mosaicMethod%22%3A%22esriMosaicLockRaster%22%2C%22lockRasterIds%22%3A%5B8%5D%7D&f=json`,
      JSON.stringify(sampleResponse),
    );
  ...
  it("should identify a pixel value with rendering rule", (done) => {
    ...
    server.respondWith(
      "GET",
      `${imageServiceUrl}identify?returnGeometry=false&geometry=%7B%22x%22%3A-122.66%2C%22y%22%3A45.51%2C%22spatialReference%22%3A%7B%22wkid%22%3A4326%7D%7D&geometryType=esriGeometryPoint&renderingRule=%7B%22rasterFunction%22%3A%22RFTAspectColor%22%7D&f=json`,
      JSON.stringify(sampleResponse),
    );
  ...
  it("should identify a pixel value with a pixel size array", (done) => {
    ...
    server.respondWith(
      "GET",
      `${imageServiceUrl}identify?returnGeometry=false&geometry=%7B%22x%22%3A-122.66%2C%22y%22%3A45.51%2C%22spatialReference%22%3A%7B%22wkid%22%3A4326%7D%7D&geometryType=esriGeometryPoint&pixelSize=15%2C15&f=json`,
      JSON.stringify(sampleResponse),
    );
  ...
  it("should identify a pixel value with a pixel size string", (done) => {
    ...
    server.respondWith(
      "GET",
      `${imageServiceUrl}identify?returnGeometry=false&geometry=%7B%22x%22%3A-122.66%2C%22y%22%3A45.51%2C%22spatialReference%22%3A%7B%22wkid%22%3A4326%7D%7D&geometryType=esriGeometryPoint&pixelSize=1%2C1&f=json`,
      JSON.stringify(sampleResponse),
    );
  ...
  it("should return catalog items", (done) => {
    server.respondWith(
      "GET",
      `${imageServiceUrl}identify?returnGeometry=true&geometry=%7B%22x%22%3A-122.66%2C%22y%22%3A45.51%2C%22spatialReference%22%3A%7B%22wkid%22%3A4326%7D%7D&geometryType=esriGeometryPoint&returnCatalogItems=true&f=json`,
  ...
  it("should return catalog items w/o geometry", (done) => {
    const sampleResponseWithCatalogItemsNoGeometry = deepClone(
      sampleResponseWithCatalogItems,
    );
    const sampleResultsWithCatalogItemsNoGeomerty = deepClone(
      sampleResultsWithCatalogItems,
    );
    for (
      let i =
        sampleResponseWithCatalogItemsNoGeometry.catalogItems.features.length -
        1;
      i >= 0;
      i--
    ) {
      delete sampleResponseWithCatalogItemsNoGeometry.catalogItems.features[i]
        .geometry;
      sampleResultsWithCatalogItemsNoGeomerty.catalogItems.features[
        i
      ].geometry = null;
    }
    server.respondWith(
      "GET",
      `${imageServiceUrl}identify?returnGeometry=false&geometry=%7B%22x%22%3A-122.66%2C%22y%22%3A45.51%2C%22spatialReference%22%3A%7B%22wkid%22%3A4326%7D%7D&geometryType=esriGeometryPoint&returnCatalogItems=true&f=json`,
  ...
  it("should pass through arbitrary parameters", (done) => {
    ...
    server.respondWith(
      "GET",
      `${imageServiceUrl}identify?returnGeometry=false&geometry=%7B%22x%22%3A-122.66%2C%22y%22%3A45.51%2C%22spatialReference%22%3A%7B%22wkid%22%3A4326%7D%7D&geometryType=esriGeometryPoint&foo=bar&f=json`,
      JSON.stringify(sampleResponse),
    );
