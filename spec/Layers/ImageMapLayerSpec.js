...
describe("L.esri.ImageMapLayer", () => {
  ...
  const url =
    "http://services.arcgis.com/mock/arcgis/rest/services/MockImageService/ImageServer";
  let layer;
  let server;
  let map;
  let clock;
  ...
  it("should have a L.esri.imageMapLayer alias", () => {
    expect(
  ...
  it("should pass the pane option through to the image", (done) => {
    layer.on("load", () => {
  ...
  it("should bind a popup to the layer", () => {
    ...
    layer.bindPopup(
      (error, results) => `Pixel value: ${results.pixel.properties.value}`,
    );
  ...
  it("should bind a popup to a layer with a mosaic rule", () => {
    server.respondWith(
      "GET",
      new RegExp(
  ...
  it("should get and set rendering rule", (done) => {
    server.respondWith(
      "GET",
      new RegExp(
    ...
    expect(layer.getRenderingRule()).to.deep.equal({
  ...
  it("should get and set mosaic rule", (done) => {
    server.respondWith(
      "GET",
      new RegExp(
    ...
    expect(layer.getMosaicRule()).to.deep.equal({
      mosaicMethod: "esriMosaicLockRaster",
      lockRasterIds: [8],
    });
    layer.addTo(map);
  ...
  it("should get and set bandIds as an array param", (done) => {
    server.respondWith(
      "GET",
      new RegExp(
  ...
  it("should get and set bandIds as a string param", (done) => {
    server.respondWith(
      "GET",
      new RegExp(
        /http:\/\/services.arcgis.com\/mock\/arcgis\/rest\/services\/MockImageService\/ImageServer\/exportImage\?bbox=-?\d+\.\d+%2C-?\d+\.\d+%2C-?\d+\.\d+%2C-?\d+\.\d+&size=500%2C500&format=jpgpng&transparent=true&bboxSR=3857&imageSR=3857&bandIds=3%2C0%2C1&f=json/,
  ...
  it("should get and set noData with zero passed in the constructor", (done) => {
    server.respondWith(
      "GET",
      new RegExp(
  ...
  it("should get and set noData as a numeric param", (done) => {
    server.respondWith(
      "GET",
      new RegExp(
        /http:\/\/services.arcgis.com\/mock\/arcgis\/rest\/services\/MockImageService\/ImageServer\/exportImage\?bbox=-?\d+\.\d+%2C-?\d+\.\d+%2C-?\d+\.\d+%2C-?\d+\.\d+&size=500%2C500&format=jpgpng&transparent=true&bboxSR=3857&imageSR=3857&noData=0&f=json/,
  ...
  it("should get and set noData as an array", (done) => {
    server.respondWith(
      "GET",
      new RegExp(
  ...
  it("should get and set noDataInterpretation", (done) => {
    server.respondWith(
      "GET",
      new RegExp(
  ...
  it("should get and set pixelType", (done) => {
    server.respondWith(
      "GET",
      new RegExp(
  ...
  it("should render an images at the back if specified", (done) => {
    layer.bringToBack();
  ...
  it("should be able to request json using a proxy", () => {
    ...
    server.respondWith(
      "GET",
      new RegExp(
        /\.\/proxy.ashx\?http:\/\/services.arcgis.com\/mock\/arcgis\/rest\/services\/MockImageService\/ImageServer\/exportImage\?bbox=-?\d+\.\d+%2C-?\d+\.\d+%2C-?\d+\.\d+%2C-?\d+\.\d+&size=500%2C500&format=jpgpng&transparent=true&bboxSR=3857&imageSR=3857&f=json/,
      ),
      JSON.stringify({
        href: imageUrl,
      }),
  ...
  it("should be able to request image using a proxy", () => {
    server.respondWith(
      "GET",
      new RegExp(
        /\/proxy.ashx\?http:\/\/services.arcgis.com\/mock\/arcgis\/rest\/services\/MockImageService\/ImageServer\/exportImage\?bbox=-?\d+\.\d+%2C-?\d+\.\d+%2C-?\d+\.\d+%2C-?\d+\.\d+&size=500%2C500&format=jpgpng&transparent=true&bboxSR=3857&imageSR=3857&f=image/,
      ),
      JSON.stringify({
        imageData: Image1,
  ...
  it("should pass a token if one is set", (done) => {
    server.respondWith(
      "GET",
      new RegExp(
        /http:\/\/services.arcgis.com\/mock\/arcgis\/rest\/services\/MockImageService\/ImageServer\/exportImage\?bbox=-?\d+\.\d+%2C-?\d+\.\d+%2C-?\d+\.\d+%2C-?\d+\.\d+&size=500%2C500&format=jpgpng&transparent=true&bboxSR=3857&imageSR=3857&token=foo&f=json/,
      ),
      JSON.stringify({
        href: WithToken,
      }),
  ...
  it("should pass a token if one is set (f:image)", () => {
    layer = L.esri.imageMapLayer({
      url,
      f: "image",
    });
    ...
    expect(spy.getCall(0).args[0]).to.match(
      new RegExp(
        /http:\/\/services.arcgis.com\/mock\/arcgis\/rest\/services\/MockImageService\/ImageServer\/exportImage\?bbox=-?\d+\.\d+%2C-?\d+\.\d+%2C-?\d+\.\d+%2C-?\d+\.\d+&size=500%2C500&format=jpgpng&transparent=true&bboxSR=3857&imageSR=3857&token=foo&f=image/,
      ),
    );
  });
});
