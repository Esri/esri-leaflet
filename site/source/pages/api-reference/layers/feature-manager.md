---
title: L.esri.Layers.FeatureManager
layout: documentation.hbs
---

# {{page.data.title}}

`L.esri.Layers.FeatureManager` is used to visualize and query vector geographic data hosted in both ArcGIS Online and published using ArcGIS Server.
