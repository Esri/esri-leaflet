---
title: L.esri.Layers.FeatureGrid
layout: documentation.hbs
---

# {{page.data.title}}

`L.esri.Layers.FeatureGrid` is used to visualize and query vector geographic data hosted in both ArcGIS Online and published using ArcGIS Server.
